    ...
    return (
        <div className="container-fluid ">
            ...
            <div className='container loginForm'>
                <h3 className='text-center pb-2'><b>Login</b></h3>
                {loading ? (
                    ...
                    <form onSubmit={handleLogin}>
                        <div className="mb-3">
                            <label htmlFor="Username" className="form-label"><b>Username or Email:</b></label>
                            <input type="text" name="Username" value={loginInfo.Username} onChange={handleInputChange} className="form-control" required />
                        </div>
                        <div className="mb-3">
                            <label htmlFor="Password" className="form-label"><b>Password:</b></label>
                            <input type="password" name="Password" value={loginInfo.Password} onChange={handleInputChange} className="form-control" required />
                        </div>
                        <div className='buttonSide'>
                            <button type="submit" className="btn btn-primary rounded-pill"><b>Log In</b></button>
                        </div>
                    </form>
                )}
                <div>
                    <p className="mt-3"><Link to="/forgotPassword"><b>Forgot Password?</b></Link></p>
                    <p className='mt-3'>Don’t have an account yet? <Link to="/register"><b>Sign Up</b></Link></p>
                </div>
            </div>
