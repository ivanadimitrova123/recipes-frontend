                                ...
                                <div>
                                    ...
                                    {!isCurrentUser && (
                                        <div className="theBtns">
                                            {isFollowing ? (
                                                <button onClick={handleUnfollow} className="btn btn-danger unfollowBtn">Unfollow</button>
                                            ) : (
                                                <button onClick={handleFollow} className="btn btn-primary followBtn">Follow</button>
                                            )}
                                        </div>
                                    )}
                                </div>
                    ...
                    <div className="col-6">
                        {user && (
                            <div className="profileInfo">
                                ...
                                <p><b>{user.recipes ? user.recipes.length : 0}</b> posts</p>
                                ...
                                {isCurrentUser && (
                                    <div className="theBtns">
                                        ...
                                        <button className="btn btn-primary " onClick={handleFollowing}><b>Following List</b></button>
                                    </div>
                                )}
                            </div>
